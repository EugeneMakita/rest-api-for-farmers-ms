...
class Farmer(models.Model):
    ...
    land_category = models.CharField(
        max_length=3, choices=CATEGORY_CHOICES, default='a1')
    STATUS_OF_FARMER = [
        ('active', 'active'),
        ('pending', 'pending'),
    ...
    category = models.CharField(
        max_length=3, choices=CATEGORY_CHOICES, default='pending')
...
class Season(models.Model):
    ...
    farmer = models.ForeignKey(
        Farmer, on_delete=models.CASCADE, related_name='seasons', null=True)
    growers_number = models.CharField(max_length=50, unique=True)
...
class Bale(models.Model):
    ...
    season = models.ForeignKey(
        Season, on_delete=models.CASCADE, related_name='bales', null=True)
