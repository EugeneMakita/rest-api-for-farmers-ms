...
class SeasonNamesDetail(APIView):
    ...
    def put(self, request:Request, pk:str) -> Response:
        ...
        """
        seasonName: SeasonNames = SeasonNames.objects.get(pk=pk)
        serializer: SeasonNamesSerializer = SeasonNamesSerializer(seasonName, data=request.data)
...
class SeasonsNamesList(APIView):
    ...
    def get(self) -> Response:
        ...
        serializer:SeasonNamesSerializer = SeasonNamesSerializer(seasonNames, many=True)
        return Response(serializer.data)
    ...
    def post(self, request:Request) -> Response:
        ...
        Create a new season name.
        """
        serializer: SeasonNamesSerializer = SeasonNamesSerializer(data=request.data)
        if serializer.is_valid():
            serializer.save()
