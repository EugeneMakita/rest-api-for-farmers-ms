...
urlpatterns = [
    ...
    path('bales/qaulity', BalesQaulityList.as_view(),
         name='bale-qualities-create-index'),
    path('bales/qaulity/<uuid:pk>/', BalesQualityDetail.as_view(),
         name='bale-qualities-get-patch-delete'),

    path('comment', CommentsList.as_view(), name='comments-create-index'),
    path('comment/<uuid:pk>/', CommentsDetail.as_view(),
         name='comments-get-patch-delete'),
